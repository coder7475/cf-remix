            ...
            >
              ...
              <div>
                ...
                <div className="flex gap-3">
                  ...
                  <a target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.linkedin.com/in/robiul7475" className="w-10 h-10 rounded-full bg-secondary/70 flex items-center justify-center hover:bg-primary/10 transition-colors">
                    <Linkedin className="w-5 h-5 text-muted-foreground hover:text-foreground transition-colors" />
                  </a>
                  <a target="_blank"
                    rel="noopener noreferrer"

                    href="https://x.com/robiul7475" className="w-10 h-10 rounded-full bg-secondary/70 flex items-center justify-center hover:bg-primary/10 transition-colors">
